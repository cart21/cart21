<?php
class product_category_top extends CI_Controller {
    ...
    function index(){
    	...
    	$param["settings"]=array(
    	 ...
    	 $data=array(
    	 		"title"=>"Product Category Top",
    	 		"publisher"=>"cart21",
    	 		"plugin_type_id"=>8,
    	 		"pub_email"=>"support@cart21.com",
    	 		"p_key"=>"product_category_top", /// same as library file name
    	 		"content"=>"Product Category for top menu",
    	 		"status"=>0,
    	 		"positional"=>1,
